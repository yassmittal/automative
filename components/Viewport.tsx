...
export function Viewport({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-[radial-gradient(120%_100%_at_50%_0%,#ffffff_0%,#eef6ff_46%,#dbeafe_100%)]">
      <PlateGrid />
...
function PlateGrid() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(to right, #8bb7ff 1px, transparent 1px), linear-gradient(to bottom, #8bb7ff 1px, transparent 1px)",
